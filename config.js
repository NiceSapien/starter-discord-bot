module.exports = {
	...
	adminId: "755420913159372801", //- Replace UserId with the Discord ID of the admin of the bot
	...
	supportServer: "https://discord.gg/5Tk6sE3pFF", //- Support Server Link
	...
	cookieSecret: "nikaspin is epic", //- Cookie Secret
	...
	nodes: [
		{
			...
			host: "nikalava.azurewebsites.net", //- The host name or IP of the lavalink server.
			port: 3000, // The port that lavalink is listening to. This must be a number!
			password: "iloveyourmom", //- The password of the lavalink server.
	...
	presence: {
		...
		activities: [
			{
				name: "nikaspin mojek", //- Status Text
